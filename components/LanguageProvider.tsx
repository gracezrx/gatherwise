...
const translations = {
  en: {
    ...
    mapWaiting: "Enter a location to load the map.",
    mapWaitingHint: "The map waits until you add a host, attendee, or target neighborhood.",
    briefPlaceholder: "Start filling in details. This summary updates as you go.",
    notSet: "not set",
